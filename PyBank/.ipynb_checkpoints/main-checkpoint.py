 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "line2 = \"------------------\"\n",
    "line3 = \"\"\n",
    "line4 = (\"Total Months: \" + str(month_count))\n",
    "line5 = (\"Total: $\" + str(total_pl))\n",
    "line6 = (\"Average Change: $\" + str(average_pl))\n",
    "#line6 = ('%s %.2f' % ('Average Change: $', int(average_pl)))\n",
    "line7 = (\"Greatest Increase in Profits: \" + str(giip_date) + \" $\" + str(greatest_increase_in_profits))\n",
    "line8 = (\"Greatest Decrease in Profits: \" + str(gdip_date) + \" $\" + str(greatest_decrease_in_profits))\n",
    "\n",
    "# --------------------------------------------------\n",
